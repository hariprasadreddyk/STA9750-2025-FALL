...
Netflix’s growth in India has been fueled by a steadily expanding slate of Hindi-language Originals that deeply resonate with local audiences and increasingly travel well outside the subcontinent. These productions — ranging from prestige dramas to mass-appeal films — have collectively generated over **`r scales::comma(hindi_hours)`** hours of global viewing time, underscoring their growing role in Netflix’s international portfolio.

Within India itself, **`r hindi_titles`** distinct shows and films have broken into the weekly Top 10 rankings, holding their place on the charts for a combined **`r hindi_weeks`** weeks. This breadth of programming demonstrates not only the platform’s commitment to diverse storytelling in Hindi, but also the strong appetite among Indian viewers for homegrown content.

Among these successes, the standout has been **`r hindi_peak_title`**, which achieved a peak of more than **`r scales::comma(hindi_peak_hours)`** hours of global viewing in the week of **`r format(hindi_peak_week, "%Y-%m-%d")`**. That performance highlights the ability of a single Hindi Original to capture attention on a worldwide scale, further validating Netflix’s strategy of investing in high-quality, locally rooted stories that speak to both domestic and global audiences. 
...
#| message: false
#| warning: false
#| fig-cap: "‘Squid Game’ dominates Netflix's global viewership charts."
#| fig-align: "center"
...
ggplot(category_summary, aes(x = reorder(category, total_hours), y = total_hours, fill = category)) +
  geom_col(width = 0.6, show.legend = FALSE) +
  scale_y_continuous(labels = label_number(scale_cut = cut_short_scale())) +
  labs(
    title = "Total Viewing Hours by Category",
    subtitle = "Comparison across English and Non-English Films and TV Shows",
    x = NULL,
  ...
  scale_fill_manual(values = c("#ff6b6b", "#9acd32", "#00bcd4", "#c792ea"))
